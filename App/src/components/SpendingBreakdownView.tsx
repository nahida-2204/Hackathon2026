...
import { ArrowDown, ArrowUp, Calculator, Landmark, ShieldCheck, HeartPulse, GraduationCap, Briefcase, KeyRound, AlertTriangle } from "lucide-react";
  ...
  return (
    <div className="flex flex-col gap-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <section className="lg:col-span-8 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800/80 p-6 md:p-8 flex flex-col gap-6 rounded-2xl shadow-xs relative overflow-hidden">
        ...
        <section className="lg:col-span-4 flex flex-col gap-6">
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800/80 p-6 md:p-8 flex flex-col gap-4 rounded-2xl shadow-xs">
            ...
            <div className="text-3xl font-mono font-bold text-slate-800 dark:text-white">Rs 180 Billion</div>
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800/80 p-6 md:p-8 flex flex-col gap-4 rounded-2xl shadow-xs">
            ...
            <div className="text-3xl font-mono font-bold text-slate-800 dark:text-white">Rs 205 Billion</div>
